...
ALTER TABLE ezcontentclass_attribute ADD ( data_float1_tmp BINARY_DOUBLE DEFAULT 0 NULL );
ALTER TABLE ezcontentclass_attribute ADD ( data_float2_tmp BINARY_DOUBLE DEFAULT 0 NULL );
ALTER TABLE ezcontentclass_attribute ADD ( data_float3_tmp BINARY_DOUBLE DEFAULT 0 NULL );
ALTER TABLE ezcontentclass_attribute ADD ( data_float4_tmp BINARY_DOUBLE DEFAULT 0 NULL );
